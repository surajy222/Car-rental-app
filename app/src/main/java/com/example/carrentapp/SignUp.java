...
//    DatabaseReference reference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regBtn.setOnClickListener(v -> startActivity(new Intent(SignUp.this, SignIn.class)));


    }

    private void openactivity_signin(String email, String Password) {
        startActivity(new Intent(SignUp.this, SignIn.class).putExtra("email", email).putExtra("pass", Password).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK));
