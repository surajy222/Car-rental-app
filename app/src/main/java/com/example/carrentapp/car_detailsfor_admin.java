...
public class car_detailsfor_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_car_detailsfor_admin );
    ...
    private void saveCarDetail() {
        progressDialog = new ProgressDialog( car_detailsfor_admin.this );
    ...
    private void updateToFirebase(String databaseReferenceKey, ArrayList<String> urlStrings) throws Exception {
        ...
        databaseReference.child( databaseReferenceKey ).setValue( modal ).addOnCompleteListener( task1 -> {
            if (task1.isSuccessful()) {
                Toast.makeText( car_detailsfor_admin.this, "Successfully Updated", Toast.LENGTH_SHORT ).show();
                clearFields();
            }
        } ).addOnFailureListener( e -> Toast.makeText( car_detailsfor_admin.this, "" + e.getMessage(), Toast.LENGTH_SHORT ).show() );
    ...
    private void saveToFirebase(ArrayList<String> urlStrings) throws Exception {
        ...
        databaseReference.push().setValue( modal ).addOnCompleteListener( task1 -> {
            if (task1.isSuccessful()) {
                Toast.makeText( car_detailsfor_admin.this, "Successfully Uploaded", Toast.LENGTH_SHORT ).show();
                clearFields();
            }
        } ).addOnFailureListener( e -> Toast.makeText( car_detailsfor_admin.this, "" + e.getMessage(), Toast.LENGTH_SHORT ).show() );
